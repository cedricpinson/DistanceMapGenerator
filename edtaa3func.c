...
#define SQRT2 1.4142136
    ...
    // TODO: Compute reasonable values for gx, gy also at edges and corners.
    // (These are zero for now, which works OK but gives less accuracy.)
    // 2x2 kernels would be suitable for this.
}
